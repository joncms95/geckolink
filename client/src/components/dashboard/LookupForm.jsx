  ...
  return (
    <div className="rounded-xl border border-gecko-dark-border bg-gecko-dark-card p-4">
      ...
      <p
        ...
        data-scroll-target={SCROLL_TARGETS.LINK_LIST}
      >
        Click <strong className="text-white">View Stats →</strong> on a short
        link below to see detailed analytics, including clicks over time, top
        locations, and a usage report.
      </p>
    </div>
  );
}
