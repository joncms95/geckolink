 ...
 */
export default function MetricsGridLoading({ colSpan = 4, ariaLabel = "Loading stats" }) {
  const gridClass = colSpan === 2 ? "col-span-2" : "col-span-2 lg:col-span-4"
  return (
    <div className={`${gridClass} flex items-center justify-center py-8`} aria-label={ariaLabel}>
